...
- [Configure LLM Providers for an Agent](../../guides/register-llm-service-provider.mdx#configure-an-agent-to-use-a-provider) — attaching providers to platform and external agents
