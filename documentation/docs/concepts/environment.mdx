...
An Environment is a stage your agents run in, typical examples can be development, staging, and production. Every agent deployment, gateway registration, and MCP proxy endpoint in Agent Manager is scoped to one or more environments.
