...
variables. See [Use AgentID in a Platform-Hosted Agent](../tutorials/use-agentid-in-platform-hosted-agents.mdx)
...
[Retrieve AgentID Credentials for an Externally-Hosted Agent](../tutorials/retrieve-agentid-for-externally-hosted-agents.mdx)
...
- [Use AgentID in a Platform-Hosted Agent](../tutorials/use-agentid-in-platform-hosted-agents.mdx)
- [Retrieve AgentID Credentials for an Externally-Hosted Agent](../tutorials/retrieve-agentid-for-externally-hosted-agents.mdx)

:::note
AgentID's per-environment ThunderID instances are separate from the
[identity providers you configure on a gateway](../guides/configure-identity-providers.mdx)
