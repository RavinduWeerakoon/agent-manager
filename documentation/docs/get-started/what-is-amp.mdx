...
- To see how the platform fits together see [Architecture](./architecture.mdx).
- To try it out directly, follow the [Quick Start Guide](./quick-start.mdx) to get Agent Manager running and deploy your first agent.

## Contributing

We welcome contributions from the community! See the [Contributing Guidelines](../contributing/contributing.mdx) to get started.
