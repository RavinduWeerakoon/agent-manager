...
- Compliance teams can update rules without relying on developers.
...
[Register an AI Gateway](../guides/register-ai-gateway.mdx).

![deployed gateway list](../img/tutorials/control-what-your-agent-respond-to/gateway-list.png)
