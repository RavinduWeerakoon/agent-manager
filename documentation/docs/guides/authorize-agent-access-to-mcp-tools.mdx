...
- An AI Gateway registered and active for the environment you are configuring (see [Register an AI Gateway](./register-ai-gateway.mdx)).
...
- [Configure Agent MCP Proxies](./register-mcp-proxy.mdx#configure-an-agent-to-use-a-proxy) — attach a proxy to an agent so it can call the tools.
