...
- An active AI Gateway for the environments you want to configure. On Agent Manager Cloud these are provisioned for you.
...
1. Log in to the WSO2 Agent Manager Console (`https://console.agent-manager.cloud.wso2.com/`).
